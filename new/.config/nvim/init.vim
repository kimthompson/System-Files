...
Plug 'NLKNguyen/papercolor-theme'                       " my classic
Plug 'dracula/vim', { 'as': 'dracula' }                  " the new classic
...
Plug 'Shougo/deoplete.nvim', { 'do': ':UpdateRemotePlugins' } " get rid of errors?
